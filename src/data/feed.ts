...
export type FeedReply = { who: string; text: string; mine?: boolean; publicId?: string; cid?: number; photo?: string; uid?: number };
export type FeedComment = { who: string; text: string; mine?: boolean; replies: FeedReply[]; cid?: number; publicId?: string; photo?: string; uid?: number };
