...
export type ChatMsg = { name: string; time: string; text: string; mod?: boolean; host?: boolean; myOwn?: boolean; photo?: string; uid?: number; publicId?: string; sys?: "mesaj" | "uyari"; baslik?: string; hediye?: HediyeSatiri;
  yetki?: boolean; ozelIdTip?: "premium" | "kapsul" | null; ozelIdTema?: string | null };
...
export const ROOMS: Room[] = [
  ...
  { id: "145632", name: "EĞLENECEKSEN GEL 🔥", host: "Mervee", online: 126, mic: 8, extra: 73, live: true, scene: "club", crowd: ["Mervee", "Zeno Sv.", "Lunas", "Ender", "Furkan"], friends: 4, badges: [{ type: "hot_streak" }, { type: "lv", n: 18 }, { type: "energy_star" }, { type: "event_master" }, { type: "popular" }] },
  ...
  { id: "146114", name: "UYKUM YOK 🌙", host: "Zeno Sv.", online: 81, mic: 7, extra: 48, live: true, scene: "night", crowd: ["Zeno Sv.", "Furkan", "Ender", "Melis", "Rüya"], friends: 2, badges: [{ type: "lv", n: 9 }, { type: "night_owl" }, { type: "chat_master" }, { type: "legendary" }] },
