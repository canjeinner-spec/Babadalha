...
export const METINLER = {
  ...
  "jeton.baslik": { tr: "İzleme Jetonları", en: "Watch Tokens" },
  "jeton.kart": { tr: "İzleme jetonların", en: "Your watch tokens" },
  "jeton.saat": { tr: "{0} saat reklamsız izleme", en: "{0} hours of ad-free watching" },
  "jeton.orani": { tr: "1 jeton = {0} dakika", en: "1 token = {0} minutes" },
  "jeton.reklamBaslik": { tr: "+{0} jeton", en: "+{0} token" },
  "jeton.reklamMetin": {
    tr: "Bir reklam izle, bir jeton kazan. İstediğin kadar izleyebilirsin, jetonlar birikir.",
    en: "Watch one ad, earn one token. Watch as many as you like, tokens add up.",
  },
  "jeton.reklamDugme": { tr: "Reklam izle", en: "Watch ad" },
  "jeton.reklamYukleniyor": { tr: "Reklam açılıyor…", en: "Opening the ad…" },
  "jeton.kazanildi": { tr: "{0} jeton hesabına geçti.", en: "{0} token added to your account." },
  "jeton.reklamOlmadi": { tr: "Reklam açılamadı, birazdan tekrar dene.", en: "The ad could not open, try again shortly." },
  "jeton.hediyeBaslik": { tr: "Günlük hediyen", en: "Your daily gift" },
  "jeton.hediyeMetin": { tr: "Her gün {0} jeton bizden, reklam izlemene gerek yok.", en: "{0} token from us every day, no ad needed." },
  "jeton.hediyeDugme": { tr: "Al", en: "Claim" },
  "jeton.hediyeAlindi": { tr: "Bugünkü hediyeni aldın.", en: "You have claimed today's gift." },
  "jeton.premiumBaslik": { tr: "Premium ile jeton derdi yok", en: "No token worries with Premium" },
  "jeton.premiumDolum": { tr: "Her gün {0} jetona doldururuz", en: "We top you up to {0} tokens every day" },
  "jeton.premiumDolumAlt": {
    tr: "Reklam izlemeden izlemeye devam edersin, bakiyen her gün kendiliğinden dolar.",
    en: "Keep watching without ads; your balance refills on its own every day.",
  },
  "jeton.premiumReklamsiz": { tr: "Reklam yok", en: "No ads" },
  "jeton.premiumDolumKisa": { tr: "Jeton dolumu", en: "Token refills" },
  "jeton.premiumFazlasi": { tr: "Daha fazlası", en: "And more" },
  "jeton.premiumDugme": { tr: "Premium'a geç", en: "Go Premium" },
  "jeton.iptalNotu": { tr: "İstediğin zaman iptal edebilirsin", en: "Cancel whenever you want" },
  "jeton.dolumAlindi": { tr: "Bakiyen {0} jetona dolduruldu.", en: "Your balance was topped up to {0} tokens." },
  "jeton.dolumHazirDegil": { tr: "Bakiyen zaten dolu.", en: "Your balance is already full." },
  "jeton.nasilBaslik": { tr: "Jeton nasıl çalışır?", en: "How do tokens work?" },
  "jeton.nasilMetin": {
    tr: "Bir jeton, {0} dakika boyunca reklamsız izlemeni sağlar. Sayaç yalnız izlerken işler, oda kurarken ya da sohbet ederken durur. Jetonun bittiğinde izlemen kesilmez, araya yine reklam girer.",
    en: "One token gives you {0} minutes of ad-free watching. The timer only runs while you watch; it stops while you set up a room or chat. When your tokens run out your watching is not cut off, ads simply come back.",
  },
  "jeton.kalanSure": { tr: "Reklamsız izlemene {0} kaldı", en: "{0} of ad-free watching left" },
