...
class MslIstek(private val oturum: MslOturum) {
  ...
  fun anahtarDegisimiYuku(yenileme: Boolean): String {
    ...
    anahtarVeri.put("publickey", MslOturum.base64Kodla(oturum.anahtarCifti!!.public.encoded))
  ...
  fun sahipTokenYuku(): String {
    ...
    val av = JSONObject()
    av.put("publickey", MslOturum.base64Kodla(oturum.anahtarCifti!!.public.encoded))
  ...
  private fun manifestGovde(videoId: String, mesajId: Long): String {
    ...
    govde.put("drmType", "widevine")
    govde.put("drmVersion", 25)
